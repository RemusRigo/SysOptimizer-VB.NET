...
Public Class ctrlProgressBarPercentage
   Inherits Control
   ...
   Protected Overrides Sub OnPaint(e As PaintEventArgs)
      ...
      ' Percentage text
      Dim percentText = CInt((_value / _maximum) * 100).ToString & "%"
      TextRenderer.DrawText(g, percentText, Me.Font, rect, Color.Black, TextFormatFlags.HorizontalCenter Or TextFormatFlags.VerticalCenter)
   End Sub
