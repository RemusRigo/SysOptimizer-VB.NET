...
Partial Class frmFileSystem
   ...
   Private Sub InitializeComponent()
      ...
      ' btnFSRun
      ' 
      btnFSRun.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
      btnFSRun.Location = New Point(755, 416)
      btnFSRun.Name = "btnFSRun"
      btnFSRun.Size = New Size(46, 23)
      btnFSRun.TabIndex = 2
      btnFSRun.Text = "Run"
      btnFSRun.UseVisualStyleBackColor = True
      ' 
      ' lvFileSystem
      ' 
      ...
      Controls.Add(btnFSRun)
      Name = "frmFileSystem"
      StartPosition = FormStartPosition.CenterScreen
      Text = "FileSystem"
      ResumeLayout(False)
   End Sub
   Friend WithEvents btnFSRun As Button
