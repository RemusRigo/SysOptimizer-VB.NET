...
Partial Class frmRegistry
   ...
   Private Sub InitializeComponent()
      ...
      ' btnRegRun
      ' 
      btnRegRun.Anchor = AnchorStyles.Bottom Or AnchorStyles.Right
      btnRegRun.Location = New Point(760, 414)
      btnRegRun.Name = "btnRegRun"
      btnRegRun.Size = New Size(40, 23)
      btnRegRun.TabIndex = 4
      btnRegRun.Text = "&Run"
      btnRegRun.UseVisualStyleBackColor = True
      ' 
      ' lvRegistry
      ' 
   ...
   Friend WithEvents btnRegRun As Button
